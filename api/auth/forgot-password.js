...
const RESEND_FROM    = process.env.RESEND_FROM || 'Recall Better <noreply@recallbetter.com>';
const APP_URL        = process.env.APP_URL      || 'https://recallbetter.com';
      ...
      body: JSON.stringify({
        ...
        html: `
          <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 24px; background: #090b11; color: #ede9df; border-radius: 12px;">
            <h1 style="font-family: Georgia, serif; font-weight: 300; font-size: 32px; margin: 0 0 8px; color: #ede9df;">Recall Better</h1>
